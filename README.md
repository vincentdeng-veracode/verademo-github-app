...
Blab-a-Gag is a fairly simple forum type application which allows:
 ...
 - users to comment on afweother users messages (heckle)awef
 asfwsafea
### URLsasdfawefasdfawef
awefasdfawefdasfawefwefaweawef
`/reset` will reset the dataafwef in the database wiawefth a load ofasfwe:
 - userswfeawefasdfawefsadfe
 - jokesawefsadfwe
 - hecklesawefafwef
  awef
...
`/login` allows you to logafwe in to your account
